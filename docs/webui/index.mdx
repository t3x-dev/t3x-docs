...
structure. The source may be a prompt version, support note, meeting note,
...
as a stable project version. Canvas should come after this step: before commit,
the user is still reviewing proposed state; after commit, the project has a
...
Leaf is where committed state becomes a reusable artifact. A leaf has its own
